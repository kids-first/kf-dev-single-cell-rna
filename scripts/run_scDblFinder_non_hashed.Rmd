...
output:
  html_document:
    ...
    df_print: paged
params:
  data_path: "/gpfs/data/aifantislab/home/chrona01/projects/WT1/analysis/01_RNA/data/WT1_non_hashed" # path to the directory with the outs file
  out_path: "/gpfs/data/aifantislab/home/chrona01/projects/WT1/analysis/01_RNA/data/scDblFinder_non_hashed/" # output path where the outputs will be stored
  log_file: NULL
---
...
dirs <- c(dir(path=data_path,  pattern = "seurat_obj_raw.rds", full.names=TRUE, recursive=TRUE)
            )
...
for (i in seq_along(dirs)){
    ...
    set.seed(1234)
    object_list[[i]]  <- scDblFinder(object_list[[i]], clusters=TRUE, BPPARAM= bp)
