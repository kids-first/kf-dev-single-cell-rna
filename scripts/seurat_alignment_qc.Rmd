...
params:
  ...
  max_mt: 1  # maximum percent mitochondrial reads per cell
...
results_dir <-
  file.path("/Users/chronia/CHOP/GitHub/kf-dev-single-cell-rna/scripts/example/results", paste0("Seurat-QC-", sample_name, "/"))
...
knitr::opts_chunk$set(echo = FALSE,
                      warning = FALSE, 
                      message = FALSE, 
                      fig.path = file.path(results_dir, paste0("Seurat-QC-", sample_name, "/")),
                      fig.height = 10, 
                      fig.width = 15,
                      dev = c("png"))
```
