...
date: "`r Sys.Date()`"
params:
  out_path: "/Users/chronia/CHOP/projects/HOPE/HOPE-analysis/analyses/01_snRNA-seq/data/01_QC_objects/" # path to dir to save all files
  data_path: "/Users/chronia/CHOP/projects/HOPE/HOPE-analysis/analyses/01_snRNA-seq/00-alignment/7316-2594_include_introns/outs/filtered_feature_bc_matrix/" # path to the directory with the filtered_feature_bc_matrix
  sample_name: "7316-2594_include_introns"   # name of the current sample
  samples: sample_name
...
library(ggpmisc)
library(ggrepel)
load_all("/Users/chronia/CHOP/GitHub/scooter") # PATH TO SCOOTER or to git repo with it: https://github.com/igordot/scooter
theme_set(theme_bw())
