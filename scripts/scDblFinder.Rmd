...
seurat_obj <- as.Seurat(object_list[[i]], 
...
seurat_obj$orig.ident.original <- object_list_seurat[[i]]$orig.ident
  
seurat_obj$orig.ident <- sample_name # Replace value in the "orig.ident" metadata column
  
# Save seurat_obj with doublets predictions in the metadata
saveRDS(seurat_obj, paste0(doublets_dir, "seurat_obj_with_doublets_", sample_name,".rds"))
```
