...
params:
  ...
  out_path: "/Users/chronia/CHOP/projects/HOPE/HOPE-analysis/analyses/01_snRNA-seq/data/01_QC_objects/" # output path where the outputs will be stored
...
```
Rscript -e "rmarkdown::render('7316-2594_include_introns-CREATE-v2.Rmd', clean = TRUE)"
```
