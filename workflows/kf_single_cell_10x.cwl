...
doc: |-
  ...
  The workflow runs cellranger count, velocyto, and Seurat on fastq files generated by the
  ...
  the counts of preprocessed and processed mRNA. Seurat clusters cells by
  gene expression.
