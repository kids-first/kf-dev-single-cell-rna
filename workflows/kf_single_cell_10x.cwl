...
doc: |-
  ...
  [velocyto](http://velocyto.org/), and [Seurat](https://github.com/satijalab/seurat)
  ...
  Velocyto is used to compute RNA velocity using the counts of preprocessed and
  processed mRNA. Seurat clusters cells by gene expression.
...
outputs:
  ...
  seurat_out: {type: File, outputSource: seurat/out_file}
...
steps:
  ...
  seurat:
    ...
    in:
      ...
      name: sample_name
      out_size: out_size
      scRNA_cts_tar: cellranger/matrix_out
